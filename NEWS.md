...
~~CPD regression update~~, checks for ~~CPD regression outputs and~~ household expenditure weights and bug fixes

### Additions

- ~~Option to run `estim_cpd()` with covariates and interactions~~
