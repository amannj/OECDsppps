...
This section describes alternative software solutions to implement
`OECDsppps` into existing workflows in [Python](#sec-python) and
[SAS](#sec-sas).
...
[Python in R
Markdown](https://rstudio.github.io/reticulate/#python-in-r-markdown).
...
A more detailed discussion on this integration can be found in the SAS
Communities Library “[Introducing PROC R: The Newest Way to Integrate R
and
...
as well as the Base SAS Procedures Guide “[What Does the R Procedure
Do?](https://documentation.sas.com/doc/en/pgmsascdc/v_075/proc/p13zn8bv8gu2won1dvff9a2x9qb7.htm)”.
