...
basic-heading indices [@icp2021], where the first estimation step to the
...
sPPPs provided as an input argument `data_sppps`, and joins it with a
...
expenditure weights are present but no price quotes are available.
