...
This section describes how the implement this [two-step
...
## CPD estimation at the basic heading level

sPPP at the basic heading can be estimated by combination of estim_cpd
with group_modify
...
## Index calculation based on basic heading CPD

this can be easily linked with the estim_index_link function to index
functions
...
Using the previous approach results in an error from index_geks
...
This can be solved using the complete_sppp parameter of the
estim_index_link function as shown below.
...
estim_index_link works and returns a standardized data frame
...
index functions return an error due to missing expenditure weights
