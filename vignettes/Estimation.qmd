...
The function `estim_cpd()` also has the option to to export standard errors with argument `output = "Std. Error"`.hese standard errors are used to support the validation of CPD-based subnational PPPs at the basic-heading level; see [Validation](https://amannj.github.io/OECDsppps/articles/Validation.html#sec-tobh) vignette.
