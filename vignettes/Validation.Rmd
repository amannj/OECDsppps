...
[^1]: Non-sampling errors occur for reasons such as pricing the wrong product (product error) or incorrectly recording the product’s price or unit of measure (pricing error).
